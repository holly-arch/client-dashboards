      ...
      <main className="flex-1 px-4 md:px-6 py-4 md:py-6 space-y-4 md:space-y-6">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl font-bold" style={{ color: 'var(--color-text-primary)' }}>Activity Dashboard</h1>
            <p className="text-sm mt-1" style={{ color: 'var(--color-text-faint)' }}>Live view of every workstream — content, assets, outreach, data, and timeline</p>
          </div>
