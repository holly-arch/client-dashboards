...
function pillStyle(value: string, lookup: { keys: string[]; bg: string; text: string; border: string }[]): { bg: string; text: string; border: string } {
  ...
  return { bg: 'rgba(120,120,120,0.10)', text: '#b0b0b0', border: 'rgba(120,120,120,0.30)' };
}
...
const STATUS_LOOKUP = [
  ...
  { keys: ['closed lost', 'lost', 'not interested', 'disqualified', 'unqualified'], bg: 'rgba(120,120,120,0.10)', text: '#9a9a9a', border: 'rgba(120,120,120,0.30)' },
];
