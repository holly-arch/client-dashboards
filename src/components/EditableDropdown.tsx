    ...
    <div className="relative" ref={ref}>
      <button
        ...
        style={{
          ...
          color: current ? '#ff2eeb' : 'var(--color-text-faint)',
      ...
      {open && (
        <div
          ...
          style={{ background: 'var(--color-border)', border: '1px solid var(--color-border)', minWidth: '160px' }}
        >
          {SHORT_STATUS_OPTIONS.map((opt) => (
            <button
              ...
              style={{ color: opt === current ? '#ff2eeb' : 'var(--color-text-secondary)' }}
            >
              {opt}
            </button>
          ))}
